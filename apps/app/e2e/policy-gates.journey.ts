...
function catalog(enabled: boolean): GameCatalog {
  return {
    ...
    modes: [
        ...
        availableActions: [
          {
            ...
            id: 'view-preview',
            label: 'View Marketplace Flip preview',
          },
        ],
        capabilitySource: { kind: 'fixture', name: 'rgs-fixture', status: 'gated' },
        description: 'Fixture-only Marketplace Flip.',
        id: 'flip',
      ...
      {
        availableActions: [
          { href: '/games/crash', id: 'view-preview', label: 'View Card Streak preview' },
        ],
        capabilitySource: { kind: 'fixture', name: 'rgs-fixture', status: 'gated' },
        description: 'Fixture-only Card Streak.',
        id: 'crash',
        name: 'Card Streak',
        reason: 'Fixture preview only.',
        state: 'preview',
