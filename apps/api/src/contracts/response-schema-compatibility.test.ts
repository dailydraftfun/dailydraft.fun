...
function crashReceiptPayload(): CrashReceipt {
  return {
    bindings: {
      ...
      custodyPolicyVersion: 'dailydraft.crash-custody.v1',
      inventoryPolicyHash: 'f'.repeat(64),
      inventoryPolicyVersion: 'dailydraft.crash-inventory.v1',
      ...
      settlementPolicyVersion: 'dailydraft.crash-settlement.v1',
    ...
    events: [
      {
        ...
        scheduledDeadline: '2026-07-28T12:00:30.000Z',
        stage: 1,
        terminalReason: null,
      },
      {
      ...
      },
      {
        ...
        reference: `crashref_${'3'.repeat(32)}`,
        scheduledDeadline: null,
        stage: 1,
        terminalReason: null,
      },
