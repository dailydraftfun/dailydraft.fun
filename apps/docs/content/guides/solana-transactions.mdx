---
title: Solana transaction model
description: Prepared transactions, wallet signing, finality, reconciliation, and recovery.
---

# Solana transaction model

DailyDraft uses a non-custodial transaction-preparation model.
