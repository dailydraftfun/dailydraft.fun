---
title: Canonical valuation and public proof
description: Immutable comparison policy, deterministic winners, ties, corrections, and receipts.
---

# Canonical valuation and public proof

DailyDraft commits one provider-specific comparison field before funding.
...
provider. The demo policy is `dailydraft-pokemon-tcg-market-usdc-v1`:

```text
0d8f1654c4d5c86622e207622bea835d029ecc78ed2ca1a24ba739a2c356c9fd
```

The Collector Crypt policy remains published for future partner integration:
...
`dailydraft.result-proof.v1`. Each outcome hash binds its side, provider
...
`mock-not-applicable`. The DailyDraft demo records its on-chain mint, custody,
...
[Issue #24](https://github.com/dailydraftfun/dailydraft.fun/issues/24) remains open for the
