...
- [x] Passed exact-head changed-code coverage: API 100% lines / 89.3% branches, app 98.8% / 92.7%, contracts 100% / 100%.
...
- Rebasing over the merged Flip persistence work left the generated Prisma client stale; regenerating from the rebased schema restored the API suite before exact-head coverage.
